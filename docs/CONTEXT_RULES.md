...
| Task touches CLI command behavior or installer distribution | Read `docs/decisions/0005-prebuilt-rust-harness-cli.md`, `scripts/README.md`, wrapper scripts under `scripts/*.mjs`, relevant `crates/harness-cli/*` code, CLI help output, and installer docs. |
